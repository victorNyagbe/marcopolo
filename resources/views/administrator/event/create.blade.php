                        ...
                        <form action="{{ route('event.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Saisir le nom..." required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                ...
                                <div class="col-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="timepicker" data-target-input="nearest">
                                            <input type="text" required name="hour" class="form-control datetimepicker-input" placeholder="Exemple: 22:00" data-target="#timepicker"/>
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="lieu" id="lieu" required class="form-control" placeholder="Saisir le lieu...">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="artist" id="artist" class="form-control" placeholder="Saisir le nom des artistes...">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label for="discJockey">Djs</label>
                                        <input type="text" name="discJockey" id="discJockey" class="form-control" placeholder="Saisir le nom des djs...">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="dressCode" id="dressCode" class="form-control" placeholder="Saisir le dressCode...">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="entry" id="entry" class="form-control" placeholder="Saisir le montant...">
                                            <div class="input-group-append">
                            ...
                            <div class="form-group my-4">
                                <div class="d-flex justify-content-center">
                                    <button type="submit" class="btn btn-primary px-5 py-2">Enregistrer</button>
                                </div>
