            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8">
                        <form action="{{ route('home.couvertureUpdate', $home) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="modal-body">
                                <input type="file" required name="home_image" accept=".image/jpeg,.png,.jpg" id="home_image" class="form-control">
                            </div>
                            <div class="float-right mr-5">
                                <a href="{{ route('home.couverture') }}" class="btn btn-default">Annuler</a>
