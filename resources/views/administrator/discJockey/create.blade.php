            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8">
                        <div class="card">
                            <form role="form" action="{{ route('admin.djStore') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="url" name="youtube" id="youtube" value="{{ old('youtube') }}" class="form-control" placeholder="https://youtube.com/example">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{ route('admin.djs') }}" class="btn btn-light"><i class="fa fa-arrow-circle-left"></i> Retour</a>
                                </div>
                            </form>
                        </div>
                    </div>
